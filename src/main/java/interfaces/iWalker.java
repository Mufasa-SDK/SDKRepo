...
public interface iWalker {
     ...
     */
    void step(Tile worldmapPoint, RegionBox region, Runnable actionWhileStepping);
     ...
     * initiated, not necessarily that the destination will be reached.
     */
    boolean walkTo(Tile worldmapTile, RegionBox region, Runnable actionWhileWalking);
     ...
     * @return Boolean indicating whether the path was successfully walked.
     */
    Boolean walkPath(RegionBox region, Tile[] path, Runnable whileRunning);
