...
public interface iObjects {
     ...
     *
     * @param device     Identifier for the device or screen to search on.
     ...
     */
    Rectangle within(String device, int tileRadius, String filePath);
     ...
     */
    java.util.List<Rectangle> within(String device, Rectangle rect, boolean returnAll, String filePath);
     ...
     */
    Rectangle getNearest(String device, String filePath);
}